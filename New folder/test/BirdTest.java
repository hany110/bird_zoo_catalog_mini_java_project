...
/*  assertEquals("[OTHER_BIRDS, INSECTS]", String.valueOf(b1.getFood()));
    assertEquals("HAWKS", String.valueOf(b1.getType()));
    assertEquals("Sharp nose", String.valueOf(b1.getCharacteristics()));
    assertEquals("false", String.valueOf(b1.getIsExtinct()));
    assertEquals(2, b1.getWings(), 0.01);*/
  }
